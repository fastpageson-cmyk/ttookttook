...
// (2026-07-22 종목 재선정 후, 8종목 전부 단일 종목 all-in 최악 매수→최저 홀딩이 -74%~-96%라
//  0.30(-70%)이면 어느 종목에 몰빵해도 악타이밍이면 발동한다: 신풍제약 자산 3.6%(-96%)·두산 10.3%·
//  씨젠 12.4%·엔씨 13.5% 등. 분산·능동매매엔 잘 안 걸리는 '집중 몰빵 참사' 신호로 기능한다.
//  스펙 3-5의 진짜 '잔고 0' 파산은 상장폐지 시세가 있어야 성립 — 데이터 확보 시 하향)
